...
public interface IMembershipService
{
    ...
    Task<List<MembershipPlanResponseDto>> GetActivePlansAsync();

    /// <summary>Active plans for a specific role.</summary>
    Task<List<MembershipPlanResponseDto>> GetPlansByRoleAsync(UserRole role);
