      ...
      <div className="flex flex-1 flex-col lg:pl-64">
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b border-[rgba(255,128,0,0.15)] bg-[#030303]/95 px-4 backdrop-blur-sm lg:hidden">
          <button
            ...
            aria-label="Mở menu"
            className="touch-target flex items-center justify-center rounded-lg border border-[rgba(255,128,0,0.25)] text-[#C4C7C9] transition-colors hover:bg-[#141414] hover:text-white"
          >
